...
class CheckingXlsx(models.AbstractModel):
    ...
    def get_lines(self, data):
        ...
        employee_query = """
            SELECT employee_id, max(time_checking), min(time_checking) FROM employees_checking 
    ...
    def generate_xlsx_report(self, workbook, data, lines):
        ...
        sheet.merge_range(15, 1, 18, 2, 'Họ và tên', merge_format)
        sheet.merge_range(15, 3, 18, 4, 'Team', merge_format)
        sheet.merge_range(15, 5, 18, 6, 'Trạng thái', merge_format)
